...
class ThemePublisherTest extends PHPUnit_Framework_TestCase {
	...
	{
		$publisher = m::mock('Cartalyst\Themes\ThemePublisher[getThemePaths]');
	...
	protected function getMockThemeBag($mockFilesystem = true)
	{
		...
		if ($mockFilesystem === true) $themeBag->shouldReceive('getFilesystem')->andReturn(m::mock('Illuminate\Filesystem\Filesystem'));
